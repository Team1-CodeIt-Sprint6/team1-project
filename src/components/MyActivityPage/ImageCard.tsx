...
export default function ImageCard({ image, onClickDelete }: ImageProps) {
  ...
  return (
    <div className="size-my-image relative">
      ...
      {/* 이미지 삭제 버튼 */}
      <button
        className="pc:height-40 absolute bottom-[155px] left-[155px] size-6 opacity-90 hover:opacity-95 active:opacity-100 pc:left-40 pc:size-10 tablet:bottom-[190px] tablet:left-[190px] tablet:size-8"
        type="button"
